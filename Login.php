...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($email === '' || $password === '') {
        header('Location: /School-Managment-System/Login.php?error=' . urlencode('Email and password are required.'));
        exit;
    }
    ...
    if (!$result['success']) {
        header('Location: /School-Managment-System/Login.php?error=' . urlencode($result['message']));
        exit;
    }
...
<body>
    ...
    <div class="auth-container">
        <div class="auth-card">
            <h1>Welcome Back</h1>
            <p class="subtitle">Sign in to your School account</p>
